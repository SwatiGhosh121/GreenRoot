...
CREATE TABLE `SoilData` (
    ...
    `recommendedCrop` VARCHAR(191) NULL,
...
-- AddForeignKey
ALTER TABLE `SoilData` ADD CONSTRAINT `SoilData_farmId_fkey` FOREIGN KEY (`farmId`) REFERENCES `Farm`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
